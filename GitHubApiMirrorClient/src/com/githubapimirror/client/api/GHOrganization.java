...
/**
 * Represents a GitHub organization from the GitHub mirror API, containing a
...
public class GHOrganization {
	...
	public GHOrganization(OrganizationJson json, GHConnectInfo connection) {
	...
	public List<GHRepository> getRepositories() {
		...
		OrganizationJson org = client.getOrganization(name).orElse(null);
		if (org == null) {
			return null;
		}
		...
		Owner owner = Owner.org(name);

		for (String repository : org.getRepositories()) {
